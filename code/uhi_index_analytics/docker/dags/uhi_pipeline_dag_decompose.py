...
for size in tabular_sizes:
    ...
    if size == '1x1':
        perform_base_feature_engineering_task >> tabular_tasks[size]
        convert_canopy_to_tiff_task >> tabular_tasks[size]
        process_population_task >> tabular_tasks[size]
        
    elif size == '3x3':
        glcm_tasks[1] >> tabular_tasks[size]
    elif size == '5x5':
        glcm_tasks[2] >> tabular_tasks[size]
    elif size == '9x9':
        glcm_tasks[4] >> tabular_tasks[size]
    elif size == '15x15':
        glcm_tasks[7] >> tabular_tasks[size]
